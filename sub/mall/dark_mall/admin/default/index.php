...
<!-- 메뉴의 시작 -->
<tr height=45>
<td width="160"><a href="./"><img src="../image/logo/logo.gif" width="160" height="45" border="0"></a></td>
...
<!-- 본문의 시작 -->
	...
	<?
	IF($mn) { // mn의 값이 있을 경우 ../template/leftmenu.php 를 불러옵니다. // 서브 메뉴
		INCLUDE "../template/left_menu.php";
	} ELSE { // mn의 값이 없을 경우 ../template/home.php 를 불러옵니다. // 메인 화면
