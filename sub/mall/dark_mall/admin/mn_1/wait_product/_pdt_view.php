...
<head>
	...
	function PrdList() {
		location.href="./?page=<?=$page?>&limit=<?=$limit?>&q=<?=$q?>";
	}
	
	function PrdDelete() {
	
		if(confirm("본 상품정보를 삭제하시겠습니까?     ")) {
			location.href="_result.php?result=drop&product_code=<?=$product_code?>&page=<?=$page?>&limit=<?=$limit?>";
		}
	}
	</script>
...
<td>
	...
	<tr><td height=25>
		...
		<td align=center background="../../image/more/title_main.gif">
			...
			<tr height=22>
			<td width=40></td>
			<td width=750 class="hr_text">등록설정</td>
			</tr>
			</table>
		</td>
		</tr>
	...
	<td background="../../image/more/title_sub.gif">
		<table border=0 cellpadding=0 cellspacing=0>
		<tr>
		<td style="padding:5 0 0 40" class="product">설정 변경</td></tr>
		</table>
	</td>
	</tr>
	...
	<tr><td height=5 bgcolor="#ffffff">
		...
		function ChangeForm() {
			if(confirm("설정을 변경하시겠습니까?     ")) {
				UserTypeChange.action="_result.php";
			} else {
				return false;
			}
		}
		...
		<table border=0 cellpadding=0 cellspacing=0>
		<tr><td colspan=3 height=10></td></tr>
		<form name="UserTypeChange" method="post" onsubmit="return ChangeForm()">
		...
		<input type="hidden" name="result" value="openmarket_modify">
		<tr><td width=40></td><td width=730>
			<table border=0 cellpadding=0 cellspacing=0>
			<tr>
			<td class="bold_name">
			<input type="radio" name="user_type" value="0" <?if(!strcmp($LoadProductFetch[user_type],"0")) { print "checked";}?>> 등록대기
			<input type="radio" name="user_type" value="1" <?if(!strcmp($LoadProductFetch[user_type],"1")) { print "checked";}?>> 보류하기
			<input type="radio" name="user_type" value="2" <?if(!strcmp($LoadProductFetch[user_type],"2")) { print "checked";}?>> 진열하기
			</td>
			<td width=10></td>
			<td><input type="image" src="../../image/openmarket/bt1.gif" width="96" height="21" border="0"></td>
			</tr>
			</table>
		</td><td width=20></td></tr>
		</form>
	...
	<td background="../../image/more/title_sub.gif">
		<table border=0 cellpadding=0 cellspacing=0>
		<tr>
		<td style="padding:5 0 0 40" class="product">현재상태</td></tr>
		</table>
	</td>
	</tr>
	...
	<tr><td height=5 bgcolor="#ffffff">
		...
		<tr><td colspan=3 height=10></td></tr>
		<tr><td width=40></td><td width=730 class="bold_name">
			<img src="../../image/openmarket/icon<?=$LoadProductFetch[user_type]?>.gif" width="66" height="25" alt="">
