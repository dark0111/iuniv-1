...
<body bgcolor="#ffffff" topmargin=0>
	...
	<?
	$category_QueryLoad = "select cate_name, cate_info from $categorySQL where no='$no'";
	...
	<tr>
	<td><input type="image" src="../../image/more/cate_<?=$Button_MenuValue[$wcn-2]?>_modify.gif" width="96" height="21"></td>
	<td width=5></td>
	<td><a href="javascript:cancelModify()"><img src="../../image/more/cancel.gif" width="96" height="21" border="0"></a></td>
	</tr>
	</form>
	</table>
