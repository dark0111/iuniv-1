...
$CATEVALUE .= " > <a href=\"/myShopping/sell/sellhome.html\" class='user_category_value'>".$HTTP_SESSION_VARS[ON_NAME]."님의 판매상품 홈</a> > 상품정보 보기";
...
if(!strcmp($LoadProductFetch[user_type],"0")) {
	$SellDir = "../waitpdt/waitpdt.php";
} else if(!strcmp($LoadProductFetch[user_type],"1")) {
	$SellDir = "../outpdt/outpdt.php";
} else if(!strcmp($LoadProductFetch[user_type],"2")) {
...
<html>
<head>
	<title><?=$HTTP_SESSION_VARS[ON_NAME]?>의 등록보류 상품 </title>
	...
	<style>
	textarea {
	  behavior:url("../../../include/web_edit/itp_editor.htc");
	}
	...
	<td bgcolor="#ffffff" width="900" align=center>
		...
		<td>
			...
			<tr><td height=5 bgcolor="#ffffff">
				...
				?>
				<textarea itp_edit="true" cols="95" rows="14" name="product_contents"><?=$product_contents?></textarea>
			...
			<tr><td align=center>
				...
				<td width=5></td>
				<td><a href="javascript:addCancel()"><img src="../../../image/more/product_modify_cancel.gif" width="96" height="21" border="0"></a></td>
				</tr>
				</table>
			</td></tr>
			</table>
