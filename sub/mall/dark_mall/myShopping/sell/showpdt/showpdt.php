...
$CATEVALUE .= " > <a href=\"/myShopping/sell/sellhome.html\" class='user_category_value'>".$HTTP_SESSION_VARS[ON_NAME]."님의 판매상품 홈</a> > 진열중인 상품";
...
<html>
<head>
	<title><?=$HTTP_SESSION_VARS[ON_NAME]?>의 진열중인 상품 </title>
...
<td bgcolor="#ffffff">
	...
	<td bgcolor="#ffffff" width="900" align=center>
		...
		if($q) {
			$qExtendQuery = " and user_type='2' and (extend_cate_name like '%$q%' or product_code like '%$q%' or product_name like '%$q%' or second_product_name like '%$q%')";
		} else {
			$qExtendQuery = " and user_type='2'";
		}
