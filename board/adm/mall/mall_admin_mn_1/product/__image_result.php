...
IF(!STRCMP($result, "save")) { // 이미지를 저장합니다. <시작>
	...
	if($product_image_number<6) {
		...
		if(!strcmp($ExtendName,"jpg") or !strcmp($ExtendName,"jpeg") or !strcmp($ExtendName,"gif") or !strcmp($ExtendName,"png")) {
			...
			parent.ViewImage.prd_image<?=$product_image_number?>.src = "<?=$dark_define['site_url']?>/sub/mall/dark_mall_prt_img/75/<?=$TempImageFileName?>";
			parent.ViewImage.prd_image75.src = "<?=$dark_define['site_url']?>/dark_mall_prt_img/75/<?=$TempImageFileName?>";
			parent.ViewImage.prd_image120.src = "<?=$dark_define['site_url']?>/sub/mall/dark_mall_prt_img/120/<?=$TempImageFileName?>";
			parent.ViewImage.prd_image280.src = "<?=$dark_define['site_url']?>/sub/mall/dark_mall_prt_img/280/<?=$TempImageFileName?>";
			...
			parent.opener.ProductForm.prd_image<?=$product_image_number?>.src = "<?=$dark_define['site_url']?>/sub/mall/dark_mall_prt_img/120/<?=$TempImageFileName?>";
