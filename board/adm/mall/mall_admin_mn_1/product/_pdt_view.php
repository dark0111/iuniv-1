...
<td>
	...
	<tr><td height=5 bgcolor="#ffffff" valign=top>
		...
		<table border=0 cellpadding=0 cellspacing=0>
		<tr><td colspan=3 height=10></td></tr>
		<tr><td width=40><img width=40 height=0></td><td width=730 valign=top style="border:1 dashed;border-color:#eeeeee;">
			<!--<?
	...
	<tr><td align=center>
		<table border=0 cellpadding=0 cellspacing=0>
		<tr>
		<td><a href="javascript:PrdModify()"><img src="../../mall_images/more/product_modify.gif" width="96" height="21" border="0"></a></td>
		<td width=5></td>
		<td><a href="javascript:PrdDelete()"><img src="../../mall_images/more/product_delete.gif" width="96" height="21" border="0"></a></td>
		<td width=5></td>
		<td><a href="javascript:PrdList()"><img src="../../mall_images/more/product_list.gif" width="96" height="21" border="0"></a></td>
		</tr>
		</table>
