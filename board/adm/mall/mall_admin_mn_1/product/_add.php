...
<td>
		...
		<td height=5 bgcolor="#ffffff">
			<table border=0 cellpadding=0 cellspacing=0>
				<tr><td colspan=3 height=10></td></tr>
					<tr>
						<td width=40></td><td width=730>
							<input type="text" name="company_code" size="10" maxlength="10" readonly value="<?=$company_code?>" class="input_bold"></td><td width=20>
						</td>
					</tr>
				<tr><td colspan=3 height=10></td></tr>
			</table>
	...
	<tr><td height=5 bgcolor="#ffffff">
		<table border=0 cellpadding=0 cellspacing=0>
			<tr><td colspan=3 height=10></td></tr>
			<tr><td width=40></td><td width=730>
			<input type="text" name="extend_cate_name" size=83 readonly value="<?=cate_code_to_list($cate_no)?>" class="input_bold">
			</td><td width=20></td></tr>
			<tr><td colspan=3 height=10></td></tr>
		</table>
	</td></tr>
	...
	<tr><td height=150 bgcolor="#ffffff">
		...
		<tr><td width=40></td><td width=730 height=150>
			...
			for($img=1;$img<6;$img++) {
			?>
			<td style="padding:0 10 0 10"><img src="<?if(${"prt_".$img}){ print $dark_define['site_url']."/sub/mall/dark_mall_prt_img/120/".$product_code."_".$img.".".${"prt_".$img}; } else { print $dark_define['site_url']."/board/adm/mall/mall_images/more/image13.gif";}?>" name="prd_image<?=$img?>" width="120" height="120" border="0" <?if(!strcmp($img,"1")) {?>style="border:2 solid;border-color:#66ccff;"<?}?>></td>
