...
<tr><td colspan=3 class='line2'></td></tr>
<tr >
    <td><input type=checkbox name=chk_access_ip value=1></td>
    <td>ip제한</td>
    <td>
		<table border=0 cellpadding=0 cellspacing=0 width=80%>
		<tr class='ht'>
			<td width=8%>가능ip</td>
			<td width=40%><textarea class=ed name=bo_accessY_ip rows=5 style='width:100%;'><?=$board[bo_accessY_ip] ?></textarea></td>
			<td width=4%></td>
			<td width=8%>차단ip</td>
			<td width=40%><textarea class=ed name=bo_accessN_ip rows=5 style='width:100%;'><?=$board[bo_accessN_ip] ?></textarea></td>
		</tr>
		</table>
	</td>
</tr>
<tr><td colspan=3 >*가능 ip설정시 해당 ip만 접근이 가능 합니다. 차단 ip와 가능 ip둘 모두 입력시 가능 ip 만 적용됩니다. ip는 enter로 구분됩니다.</td></tr>
