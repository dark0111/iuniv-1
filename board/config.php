...
$g4['https_url'] = "";
// 입력예
//$g4['url'] = "http://iuniv.kr";
//$g4['https_url'] = "https://iuniv.kr/board";

//jh선언변수

$g4['house_img']        = "img";
$g4['house_img_path']   = $g4['path'] . "/" . $g4['house'] . "/" . $g4['house_img'];
$g4['home_file']       = $g4['path'] . "/index.php";


//주거정보서비스 변수선언

$g4['house_img_path']	= "/imageData/";	//이미지정보 디렉토리경로 일단 최상위로잡음.
?>
