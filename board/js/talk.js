...
function talk_comment_update(id) {
    ...
    var url = 'mytalk_comment_update.php';
...
function talk_visitor_complete(req) {
    ...
    for(i=0; i<len; i++) {
        ...
        print += '<td class="my_visit_name"><a href="mytalk.php?t_id=' + get_visit_t_id + '" style="visit_name_link">' + get_visit_name + '</a></td></tr></table>';
...
function talk_friends_add(visit_t_id) {
    ...
    var url = 'mytalk_friends_add.php';
...
function talk_friends_get_content(page,to_me) {
    ...
    var url = 'mytalk_friends_get.php';
...
function friends_del(friends_t_id) {
    ...
    var url = 'mytalk_friends_del.php';
...
function talk_configure_get() {
    ...
    var url = 'mytalk_configure_get.php';
...
function talk_configure_get_complete(req) {
    ...
    form.action = 'mytalk_configure_update.php';
...
function talk_recent_comment(page,my_comment) {
    ...
    var url = 'mytalk_recent_comment_get.php';
