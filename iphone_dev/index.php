...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="utf-8" lang="utf-8" >
	<head>
		...
		<script type="text/javascript" src="./js/bigfive.js" charset="utf-8"></script>
    ...
    <body>
		...
		<form id="FoodFrm" action="./lib/food_sub.php" method="POST" class="form">
			...
			<h2>명칭 검색</h2>
            <ul style="padding: 10px 10px 10px 10px; margin: 15px 10px 17px 10px;">
                <input type="text" name="restaurant_nm" value="" style="padding: 3px 8px 8px 3px;width:220px"><a href="#" class="submit">  <img align="absmiddle" src="./img/searchButton.png"></a>				
			</ul>
			<h2>많이 찿는집</h2>
