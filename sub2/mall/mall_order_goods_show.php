	...
	<tr height=24>
		<td bgcolor="#222222" height="22" width="100%" class=uni3Dinset>
	...
	<?
	$total_basket=$Sbasket->basket_count();
	$total_money=0;
	$total_point=0;

	for($c=0;$c<$total_basket;$c++)
	{
		$brow_temp=$Sbasket->basket_fetch();
	...
	<tr height=24>
		<td >
			<table border=0 cellpadding=0 cellspacing=0 >
			<tr>
				<td width=75 align=center><img src='$dark_define[site_url]/dark_mall_prt_img/75/$LoadProductFetch[product_code]_1.jpg' border='0' onerror=\"this.src='$dark_define[site_url]/dark_mall_prt_img/none/75.gif';\" style='border:1 solid;border-color:#c4c4c4;'></td>
			...
			$total_money+=($LoadProductFetch[price]-$LoadProductFetch[sale_price])*$brow[goods_count];
