...
<td>
	...
	<tr><td height=5 bgcolor="#ffffff">
		...
		<tr><td width=40></td><td width=730>
			...
			<td><a href="javascript:idsearch()"><img src="../../image/more/id_search.gif" width="96" height="21" border="0"></a></td>
			</tr>
	...
	<tr><td height=5 bgcolor="#ffffff">
		...
		<input type="text" name="name" size="15" maxlength="10" class="TextBox">
	...
	<tr><td height=5 bgcolor="#ffffff">
		...
		<tr><td colspan=3 height=10></td></tr>
		<tr><td width=40></td><td width=730>
		<input type="text" name="jumin1" size="6" maxlength="6" class="TextBox" OnKeyUp="if(MemberForm.jumin1.value.length >= 6){ MemberForm.jumin2.focus();}" onblur="Num(this)">
		-
		<input type="password" name="jumin2" size="7" maxlength="7" class="TextBox" OnKeyUp="if(MemberForm.jumin2.value.length >= 7){ MemberForm.add_2.focus();}" onblur="Num(this)">
