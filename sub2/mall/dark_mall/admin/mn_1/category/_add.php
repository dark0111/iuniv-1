...
if($no) {
	...
	if(!strcmp($cateFetch[wcn],4)) {
		...
		print $cate_2_name." > ".$cate_3_name." > ".$cate_4_name." > <strong>".$cateFetch[cate_name]."</strong>";
		...
		print $cate_2_name." > ".$cate_3_name." > <strong>".$cateFetch[cate_name]."</strong>";
		...
		print $cate_2_name." > <strong>".$cateFetch[cate_name]."</strong>";

	} else if(!strcmp($cateFetch[wcn],1)) {

		print "<strong>".$cateFetch[cate_name]."</strong>";
...
// 현재 카테고리의 정보를 불러옴 <시작>
$category_QueryLoad = "select scn, cate_name, cate_info from $categorySQL where no='$no'";
...
?>
	...
	<td bgcolor="#eeeeee" width=150 align=center>
		...
		<tr>
		<td width="20"><img src="../../image/icon/cate_1<?=$c1t?>.gif" width="16" height="16" border="0"></td>
		<td width="20"><img src="../../image/icon/cate_2<?=$c2t?>.gif" width="16" height="16" border="0"></td>
		<td width="20"><img src="../../image/icon/cate_3<?=$c3t?>.gif" width="16" height="16" border="0"></td>
		<td width="32"><img src="../../image/icon/cate_4<?=$c4t?>.gif" width="28" height="16" border="0"></td>
		</tr>
		</table>	
	...
	?>	
		...
		?>
		<td style="padding:0 2 0 0"><img src="../../image/more/move_not_image.gif" width="108" height="19" alt=""></td>
		<?
		}
		?>
		...
		?>
		<td style="padding:0 2 0 0"><a href="javascript:which('<?=$no?>','<?=$category_FetchLoad[scn]?>','<?=$wcn?>','up')"><img src="../../image/more/move_up_image.gif" width="55" height="19" border="0"></a></td>
		<?
		}
		?>
		...
		?>
		<td style="padding:0 0 0 2"><a href="javascript:which('<?=$no?>','<?=$category_FetchLoad[scn]?>','<?=$wcn?>','down')"><img src="../../image/more/move_down_image.gif" width="68" height="19" border="0"></a></td>
		<?
		}
		?>
	...
	<tr>
	<td><a href="javascript:categoryModification('<?=$no?>','<?=$scn?>','<?=$wcn?>')"><img src="../../image/more/cate_<?=$Button_MenuValue[$wcn-2]?>_modify.gif" width="96" height="21" border="0"></a></td>
	...
	<td width=5></td>
	<td><a href="javascript:categoryDrop('<?=$no?>', '<?=$wcn-1?>')"><img src="../../image/more/cate_<?=$Button_MenuValue[$wcn-2]?>_drop.gif" width="96" height="21" border="0"></a></td>
...
?>
	...
	<input type="hidden" name="extend_cate_name" value="<?=categoryLoad($categorySQL, $connection, $no, "0")?>">
	...
	<td bgcolor="#eeeeee" width=150 align=center>
		...
		<table border=0 cellpadding=0 cellspacing=0>
		<tr>
		<td width="20"><img src="../../image/icon/cate_1<?=$c1?>.gif" width="16" height="16" border="0"></td>
		<td width="20"><img src="../../image/icon/cate_2<?=$c2?>.gif" width="16" height="16" border="0"></td>
		<td width="20"><img src="../../image/icon/cate_3<?=$c3?>.gif" width="16" height="16" border="0"></td>
		<td width="32"><img src="../../image/icon/cate_4<?=$c4?>.gif" width="28" height="16" border="0"></td>
		</tr>
		</table>	
	
	</td>
	<td bgcolor="#ffffff" width=380>
	<?=categoryLoad($categorySQL, $connection, $no ,"1")?> <input type="text" size="20" maxlength="50" name="cate_name" onkeypress="textCheck(event)">
	</td>
	</tr>
	...
	<table border=0 cellpadding=0 cellspacing=0 align=center>
	<tr>
	<td><input type="image" src="../../image/more/cate_<?=$Button_MenuValue[$wcn-1]?>_add.gif" width="96" height="21"></td>
	</tr>
	</form>
	</table>
