		...
		*/
		...
		<? 
			//썸네일 코드 시작
			$data_path = $g4['house_img_path'];//라이브러리 파일 참조
		...
		<table cellspacing="0" cellpadding="0" border="0" align="center">
			...
			<td  style="padding:0 0 0 0px;border:1px solid #D4DBE1;" width="430" height="330" align="center" valign="top" bgcolor=white>
			  <div style='width:430px;position:relative; overflow:hidden;' align="center" id="loadarea"><img src="<?=$view_one?>" border="0"></div>
			</td>
			<td width="10"></td>
				...
				<tr>
					<td style="border:solid 1px #D3D3D3; background-color:#E5E5E5;" height="330" valign='top'>
						...
						//echo "thumb2=>".$thumb2."<br>";
							...
							//echo "file_exists($thumb)==>".file_exists($thumb)."<br>"
							//echo "$filename==>".$filename."<br>";
							if (file_exists($thumb) && $filename) {
							?>
							
							  <td style="border:solid 1px #D0D0D0;height:60px;width:80px;">
									<a rel="enlargeimage::mouseover" rev="loadarea" href="<?=$thumb_path2?>/<?=$filename?>"><img src="<?=$thumb?>" style="border-width:0px;" /></a><?=$thumb_path2?>/<?=$filename?>
							  </td>
